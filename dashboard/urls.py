...
urlpatterns = [
    ...
    path(f"{urlEncryption('post_details')}{urlEncoding('post_details')}/<str:post_id>/", post_detail, name='post_detail'),
    path(f"{urlEncryption('search')}{urlEncoding('search')}/", search_results, name='search_results'),
    path(f"{urlEncryption('graph_anaylsis')}{urlEncoding('graph_anaylsis')}/<str:post_id>/", graphAnalysis, name='graph_anaylsis'),
